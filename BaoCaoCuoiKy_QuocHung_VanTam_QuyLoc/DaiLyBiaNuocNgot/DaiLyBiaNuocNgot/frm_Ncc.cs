...
namespace DaiLyBiaNuocNgot
{
    public partial class frm_Ncc : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qL_DaiLyBiaNuocNgotDataSet.tb_NCC' table. You can move, or remove it, as needed.
            //this.tb_NCCTableAdapter.Fill(this.qL_DaiLyBiaNuocNgotDataSet.tb_NCC);
            locktext();
            hienthi();
            khoitaoluoi();
        }
