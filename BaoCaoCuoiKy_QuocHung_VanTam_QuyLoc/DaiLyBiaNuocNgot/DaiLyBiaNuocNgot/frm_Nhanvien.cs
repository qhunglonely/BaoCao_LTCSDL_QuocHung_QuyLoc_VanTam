    ...
    public partial class frm_Taikhoan : Form
    {
        ...
        private void btsua_Click(object sender, EventArgs e)
        {
            ...
            string sql = (@"UPDATE    tb_Nhanvien
                    SET tennv =N'" + txtma.Text + "', gioitinh =N'" + cbgt.Text + "', ngaysinh =N'" + txtngaysinh.Text + "', dienthoai =N'" + txtdt.Text + "', diachi =N'" + txtdc.Text + "', maca =N'" + cbmaca.Text + "', macv=N'" + cbmacv.Text + "'  where manv=N'" + txtma.Text + "'");
        ...
        private void cbmaca_SelectedIndexChanged_1(object sender, EventArgs e)
        {
